...
public class IndicatorView extends LinearLayout {
    ...
    public IndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        pointSize = Common.dp2px(context, size);
        marginLeft = Common.dp2px(context, marginSize);
    }
    ...
    public void initIndicator(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                v.setBackgroundResource(R.drawable.bg_circle_green);
            } else {
    ...
    public void playByStartPointToNext(int startPosition, int nextPosition) {
        ...
        ViewNext.setBackgroundResource(R.drawable.bg_circle_green);
