package cc.lzsou.lschat.activity.scan.activity;
...
import cc.lzsou.lschat.activity.scan.camera.CameraManager;
import cc.lzsou.lschat.activity.scan.decode.DecodeThread;
import cc.lzsou.lschat.activity.scan.utils.BeepManager;
import cc.lzsou.lschat.activity.scan.utils.CaptureActivityHandler;
import cc.lzsou.lschat.activity.scan.utils.InactivityTimer;
    ...
    private void init() {
        ...
        tbLight.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    tvLight.setText("关灯");
                    tbLight.setBackgroundResource(R.mipmap.ic_scan_light);
                    openFlashlight();
                } else {
                    tvLight.setText("开灯");
                    tbLight.setBackgroundResource(R.mipmap.ic_scan_light_off);
                    closeFlashlight();
                }
            }
        });
