...
public class AudioRecoderHelper {
    ...
    public AudioRecoderHelper() {
        this(FileManager.getInstance().getVoicePath());
    }

    public AudioRecoderHelper(String filePath) {
    ...
    public void startRecord(Context context) {
        if (!CheckPermissionHelper.isHasPermission(context)) {
    ...
    public long stopRecord() {
        ...
        audioStatusUpdateListener.onStop(time, id);
        filePath = "";
