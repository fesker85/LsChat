package cc.lzsou.lschat.core.utils;
...
public class QRCodeUtil {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size, @Nullable String character_set, @Nullable String error_correction, @Nullable String margin, @ColorInt int color_black, @ColorInt int color_white, @Nullable Bitmap targetBitmap, @Nullable Bitmap logoBitmap, float logoPercent) {

        /** 1.参数合法性判断 */
        if (content == null || content.equals("")) { // 字符串内容判空
            return null;
        }
        ...
        try {
            ...
            if (error_correction == null || error_correction.equals("")) {
