...
public abstract class HttpPostHandler {
    ...
    public HttpPostHandler(Context context, String url, Map<String,String> parameters){
        this.context=context;
        this.url=url;
        this.parameters=parameters;
        onProcess();
    }
    public HttpPostHandler(Context context, String url, Map<String,String> parameters, boolean show, String msg){
        this.context=context;
        this.show=show;
        this.msg=msg;
        this.url=url;
    ...
    private void onProcess(){
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                return HttpHelper.doPost(url, parameters);
            }
